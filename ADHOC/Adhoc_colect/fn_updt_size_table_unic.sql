-- Function: admin.fn_updt_size_table_unic()

-- DROP FUNCTION admin.fn_updt_size_table_unic();

CREATE OR REPLACE FUNCTION admin.fn_updt_size_table_unic()
  RETURNS integer AS
$BODY$ 
...
-- Get OID of object to collect size.
    ...
    LOOP
      ...
      UPDATE admin.size_tables_adhoc
    ...
    UPDATE admin.size_tables_adhoc c 
